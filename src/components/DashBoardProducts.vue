...
export default {
  ...
  methods: {
    ...
    updateProduct() {
      let api = `${process.env.APTPATH}/api/${process.env.CUSTOMPATH}/admin/product`;
      let httpMethod = "post";
      const vm = this;
      if (!vm.isNew) {
        api = `${process.env.APTPATH}/api/${process.env.CUSTOMPATH}/admin/product/${vm.tempProduct.id}`;
        httpMethod = "put";
      }
      console.log(process.env.APTPATH, process.env.CUSTOMPATH);
    ...
    deleteProduct() {
      const vm = this;
      let api = `${process.env.APTPATH}/api/${process.env.CUSTOMPATH}/admin/product/${vm.tempProduct.id}`;
    ...
    uploadFile() {
      ...
      const url = `${process.env.APTPATH}/api/${process.env.CUSTOMPATH}/admin/upload`;
